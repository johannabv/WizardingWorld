...
namespace WizardingWorld.Infra.Initializers {
    public sealed class CurrenciesInitializer : BaseInitializer<CurrencyData> {
        ...
        protected override IEnumerable<CurrencyData> GetEntities {
            get {
                ...
                foreach (CultureInfo cul in CultureInfo.GetCultures(CultureTypes.SpecificCultures)) {
                    ...
                    var d = CreateCurrency(c.CurrencyEnglishName, c.ISOCurrencySymbol);
        ...
        internal static CurrencyData CreateCurrency(string name, string code) => new() { ID = name + code, Name = name, Code = code };
    }
}
